...
app.use('/api/auth', authRouter);               // ✅ Available
app.use('/api/properties', propertiesRouter);  // ✅ Available
app.use('/api/users', usersRouter);             // ✅ Available
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 SelfMove API server running on http://localhost:${PORT}`);
